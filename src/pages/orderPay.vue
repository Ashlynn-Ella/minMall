        ...
        <div class="container">
            <div class="info-box">               
                <div class="info-item clearfix">
                    ...
                    <div class="order-info">
                        ...
                        <p>收货信息：{{orderDetail.receiverName}} {{address.receiverMobile}} {{address.receiverProvince}} 
                            {{address.receiverCity}} {{address.receiverDistrict}} {{address.receiverAddress}}</p>
                    </div>
                    <div class="order-total">
                        <p>应付总额：<span>{{orderDetail.payment}}</span>元</p>
                ...
                <div class="info-children" v-show="isShow">
                    ...
                    <p>收货信息：<span>{{orderDetail.receiverName}} {{address.receiverMobile}} {{address.receiverProvince}} 
                            {{address.receiverCity}} {{address.receiverDistrict}} {{address.receiverAddress}}</span></p>
                    <p>商品名称：<span v-for="(item,index) in products" :key="index"><img v-lazy="item.productImage"> {{item.productName}}</span></p>
            ...
            <div class="pay-box">
                ...
                <div class="payment">
                    ...
                    <div class="pay-wechat" @click="showScan=true">
